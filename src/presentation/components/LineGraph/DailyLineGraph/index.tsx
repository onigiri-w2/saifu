...
import Xlabels from './parts/Xlabels';
import YgridLines from './parts/YgridLines';
  ...
  return (
    <GestureDetector gesture={gesture}>
      <Canvas style={{ width: appearance.dimensions.width, height: appearance.dimensions.height }} ref={canvasRef}>
        <YgridLines scale={scale} width={appearance.dimensions.width} />
        <Xlabels points={points} scale={scale} height={appearance.dimensions.height} />
        <Area
          points={points}
          scale={scale}
          color={color}
