...
export const Migration20241025 = {
  up: async (db: Kysely<any>) => {
    await db.transaction().execute(async (transaction) => {
      ...
      await transaction.schema
        ...
        .addColumn('id', SQLiteType.String, (col) => col.primaryKey())
        .addColumn('categoryIds', SQLiteType.String, (col) => col.unique().notNull())
      ...
      await transaction.schema
        ...
        .addColumn('type', SQLiteType.String, (col) => col.notNull())
        .execute();

      await transaction.schema
        .createTable('transactionCategories')
        .addColumn('id', SQLiteType.String, (col) => col.primaryKey())
  ...
  down: async (db: Kysely<any>) => {
    await db.transaction().execute(async (transactionClient) => {
      ...
      await transactionClient.schema.dropTable('transactions').execute();
    });
  },
};
